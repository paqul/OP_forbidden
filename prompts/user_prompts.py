...
inital_orchestrator_prompt = f"""Ask another LLM to connect to a VPN server in Asia or any server with authentication, \
Then navigate to YouTube video {video_url}, \
extract the video title and description, and take a screenshot of the page. \
